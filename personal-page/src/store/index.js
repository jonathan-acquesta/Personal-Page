...
export default new Vuex.Store({
    state: {
        ...
        icons: [
            { showHeader: true, showFooter: true, title: { 'pt-BR':'Download do Currículo', 'en-US': 'Download Resume'}, icon: 'mdi-file-pdf', url: 'https://github.com/jonathan-acquesta/Personal-Page/raw/master/personal-page/src/assets/JonathanCaravaggioAcquesta_Resume.pdf' },
